...
test('create a new rental', function(assert) {
  ...
  andThen(function() {
    ...
    fillIn('label:contains(Company name) input', 'MyString');
    fillIn('label:contains(Postcode) input', 'MyString');
...
test('show an existing rental', function(assert) {
  ...
  andThen(function() {
    ...
    assert.equal(find('p strong:contains(Company name:)').next().text(), 'MyString');
    assert.equal(find('p strong:contains(Postcode:)').next().text(), 'MyString');
  });
});
